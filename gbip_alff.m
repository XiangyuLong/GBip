function ALFFBrain = gbip_alff(ADataDir,voxelsize, ASamplePeriod, HighCutoff, LowCutoff, AMaskFilename, AResultFilename)
% ALFFBrain = gbip_alff(ADataDir,voxelsize, ASamplePeriod, HighCutoff, LowCutoff, AMaskFilename, AResultFilename)
% example: gbip_alff(ADataDir,3, 2, 0.08, 0.01, AMaskFilename, AResultFilename);
