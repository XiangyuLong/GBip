function [fALFFBrain, Header] = gbip_falff(ADataDir,voxelsize,ASamplePeriod, HighCutoff, LowCutoff, AMaskFilename,AResultFilename)
...
%	http://restfmri.net 
%
%   modified falff from REST toolbox for Alberta Children's Hospital
%   Need REST toolbox
